...
# Loading and install the package
...
country codes are c("AFG", "BGD", "BTN", "IND", "NPL", "PAK", "LKA") with the country names are c("Afghanistan", "Bangladesh", "Bhutan", "India )
second run: only run AFG, BGD, IND, NPL and PAK, BTN and LKR does not have enough data
to download data for each country, replace the line 35 and line 36 with the according country name and code
```{r pressure, echo = F}
